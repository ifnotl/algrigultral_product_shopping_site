...
<body>
    ...
    <div class="sidebar">
        <a href="#" onclick="loadContent('supply_history_orders.php')">历史订单管理</a>
        <a href="#" onclick="loadContent('supply_ongoing_orders.php')">未完成订单管理</a>
        <a href="#" onclick="loadContent('supply_product_management.php')">商品管理</a>
        <a href="#" onclick="loadContent('supply_account_management.php')">账号管理</a>
